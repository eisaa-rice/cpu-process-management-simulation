...
// adds a new job to the top of the stack
void JobStack::PushJobStack(Job inputJob) {
    jobArrived++;
    jobArray[jobArrived - 1] = inputJob;
}

// removes the job on the top of the stack and return it to the main function
...
// determines if the job stack is empty
...
// determines if the job stack is full
...
// prints out all jobs within the stack
...
// returns to main the arrival time of the job on the top of the stack
